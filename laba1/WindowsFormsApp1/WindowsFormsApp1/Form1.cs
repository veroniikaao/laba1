...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        {
            if (textBox3.Text == "1")
             label3.Text = "Компонент FolderBrowserDialog - Отображает интерфейс, с помощью которого пользователи могут просматривать и выбирать каталоги или создавать их \n \n Основные свойства: \n \n 1) RootFolder позволяет выбрать стандартную папку, которая будет корневой при открытии стандартного диалогового окна Windows открытия папки. \n 2) SelectedPath указывает пользовательскую папку, которая будет искаться в системной папке и фокусироваться при открытии стандартного диалогового окна Windows открытия папки. \n 3) ShowNewFolderButton определяет, будет ли отображаться кнопка создания новой папки «Создать папку» \n "; 
            else if (textBox3.Text == "2")
                label3.Text = "Компонент OpenFileDialog - Позволяет пользователям открывать файлы в стандартном диалоговом окне. \n \n Основные свойства: \n \n 1) DefaultExt: устанавливает расширение файла, которое добавляется по умолчанию, если пользователь ввел имя файла без расширения \n 2) OverwritePrompt: при значении true в случае, если указан существующий файл, то будет отображаться сообщение о том, что файл будет перезаписан \n 3) nitialDirectory: устанавливает каталог, который отображается при первом вызове окна \n \n";
            else if (textBox3.Text == "3")
                label3.Text = "Компонент SaveFileDialog - Служит для выбора сохраняемых файлов и места их сохранения. \n \n Основные свойства: \n \n 1) CreatePrompt: при значении true в случае, если указан не существующий файл, то будет отображаться сообщение о его создании \n 2) OverwritePrompt: при значении true в случае, если указан существующий файл, то будет отображаться сообщение о том, что файл будет перезаписан \n 3) Filter: задает фильтр файлов, благодаря чему в диалоговом окне можно отфильтровать файлы по расширению.";
        }
